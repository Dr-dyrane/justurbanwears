...
test("keeps the canonical Drop 02 boundary at the released thirty-four pieces", () => {
  ...
  assert.deepEqual(currentSkus, [
    ...
    "JUW-037", "JUW-038", "JUW-039", "JUW-040", "JUW-041", "JUW-042", "JUW-043", "JUW-044", "JUW-045", "JUW-046", "JUW-047", "JUW-048", "JUW-049", "JUW-050", "JUW-051", "JUW-052", "JUW-053", "JUW-054", "JUW-055", "JUW-056", "JUW-057", "JUW-058",
  ]);
});
...
test("keeps collection membership explicit and independent from sold or archive lifecycle labels", () => {
  ...
  assert.equal(new Set([...DROP_01_COMPATIBILITY_SKUS, ...DROP_02_COMPATIBILITY_SKUS]).size, 58);
