...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-26-catalogue-35` release must use checksum `9ba2922a4fb56051ad722b73c93991e6bed88ba46b2f81bc4c06e7492b8adbc1`. It adds G024 as the reviewed 42nd catalogue row with its approved seven-view public media packet. The previous `2026-08-25-catalogue-34` release remains recorded by checksum `56db5b2b7e934123a791daff0693d01aef8058db4ca7cd56bf2df224d52629d6`.

The 42-row manifest deliberately retains Drop 01 for recoverable operational retirement; the Drop 02 transition archives those 18 earlier rows and adopts the original eighteen Drop 02 rows into Studio in the same guarded release transaction. Garment 024 is the twenty-fourth Drop 02 piece and is adopted incrementally without rewriting inventory truth for pieces already operating in Studio.
