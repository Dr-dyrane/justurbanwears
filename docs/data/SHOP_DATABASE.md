...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-25-catalogue-34` release must use checksum `56db5b2b7e934123a791daff0693d01aef8058db4ca7cd56bf2df224d52629d6`. It preserves the reviewed 41-row catalogue while replacing only G023's public 03/05/06/07 media with the source-safe mannequin view and body-canon-corrected Lulu views; inventory and descriptive product truth remain unchanged. The previous `2026-08-25-catalogue-33` release remains recorded by checksum `3be78321051c0cfa33eefd97fed820656d1cffcbc2345d8d5bc76d94ccd5e631`.
