...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-24-catalogue-28` release must use checksum `7295f23bd32f0c00474d370b698e9569b8d15e42013daecd518c4b9e62b6bac1`. It extends the reviewed manifest from 35 to 36 rows with reserved SKU JUW-041 as Drop 02: the gunmetal sparkle open-back long-sleeve mini dress. Its user-authorized as-is public packet contains only accepted views 01–04; unapproved model views remain absent. The release uses the approved provisional dress price while keeping unknown tagged size, condition, and measurements behind explicit confirmation-before-payment copy. The previous `2026-08-24-catalogue-27` release remains recorded by checksum `06aea430d648ca057307f16b56b486ac3895d7cde663b4540301ebb6e9250dd9`.

The 36-row manifest deliberately retains Drop 01 for recoverable operational retirement; the Drop 02 transition archives those 18 earlier rows and adopts the eighteen new rows into Studio in the same guarded release transaction. Later Drop 02 additions are adopted incrementally without rewriting inventory truth for pieces already operating in Studio.
