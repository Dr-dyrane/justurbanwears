...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-24-catalogue-29` release must use checksum `b5388445c60f055902f7e16b0f1e66672372a2446d91b43a36bdba894367f2e7`. It extends the reviewed manifest from 36 to 37 rows with SKU JUW-043 as Drop 02: the charcoal wrap-front ruched slit midi dress. Its public packet contains the approved 01–07 views, and inventory is initialized once without rewriting operational stock truth. The previous `2026-08-24-catalogue-28` release remains recorded by checksum `7295f23bd32f0c00474d370b698e9569b8d15e42013daecd518c4b9e62b6bac1`.

The 37-row manifest deliberately retains Drop 01 for recoverable operational retirement; the Drop 02 transition archives those 18 earlier rows and adopts the original eighteen Drop 02 rows into Studio in the same guarded release transaction. Garment 019 is the nineteenth Drop 02 piece and is adopted incrementally without rewriting inventory truth for pieces already operating in Studio.
