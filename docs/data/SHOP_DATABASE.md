...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-28-catalogue-42` release must use checksum `a17908b43fca7e2e5f6eed155c1ef7e28b8fd5cc5d61f1094b3994b39dc304b7`. It adds G032-G034 as reviewed catalogue rows 50-52 with their approved seven-view public media packets. The previous `2026-08-27-catalogue-41` release remains recorded by checksum `e5195329e5af0e370fdcb760c279e4f7a26b24094182904125af15d7383a7526`; catalogue-40 remains recorded by checksum `e45ec2cd5a9be7d06eeaf2803b119e5212b9a01cecfa71ce1a44d36095ac38bc`.
