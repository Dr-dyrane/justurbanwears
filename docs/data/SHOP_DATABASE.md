...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-27-catalogue-41` release must use checksum `e5195329e5af0e370fdcb760c279e4f7a26b24094182904125af15d7383a7526`. It adds G031 as the reviewed 49th catalogue row with its approved seven-view public media packet. The previous `2026-08-27-catalogue-40` release remains recorded by checksum `e45ec2cd5a9be7d06eeaf2803b119e5212b9a01cecfa71ce1a44d36095ac38bc`; catalogue-39 remains recorded by checksum `ed2580d260d9339325c997258b2c2cfa212645924f2f39db3d19360dcc1c90b1`.

The 49-row manifest deliberately retains Drop 01 for recoverable operational retirement; the Drop 02 transition archives those 18 earlier rows and adopts the original eighteen Drop 02 rows into Studio in the same guarded release transaction. Garment 031 is the thirty-first Drop 02 piece and is adopted incrementally without rewriting inventory truth for pieces already operating in Studio.
