...
Run check, then `db:release:shop`; the release performs migrate → descriptive sync → verify atomically. The current `2026-08-26-catalogue-38` release must use checksum `3bb29dfb72f9ca3b3953f20f915ce74f62d9655c5340ece5b53cf2aedabea442`. It adds G027 as the reviewed 46th catalogue row with its approved seven-view public media packet. The previous `2026-08-26-catalogue-37` release remains recorded by checksum `6f6028ebf009c04cdd141b1870e7a589ed4aca7840b8e3ee69efe95adfa5f93f`.

The 46-row manifest deliberately retains Drop 01 for recoverable operational retirement; the Drop 02 transition archives those 18 earlier rows and adopts the original eighteen Drop 02 rows into Studio in the same guarded release transaction. Garment 027 is the twenty-eighth Drop 02 piece and is adopted incrementally without rewriting inventory truth for pieces already operating in Studio.
