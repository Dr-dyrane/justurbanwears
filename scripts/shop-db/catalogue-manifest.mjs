...
const V4_MODEL_SLUGS = new Set([
  ...
  "mauve-architectural-cutout-open-back-mini-dress",
  "near-black-open-back-structured-shoulder-midi-dress",
  "lime-one-shoulder-rosette-ruched-mini-dress",
]);
...
export const SHOP_CATALOGUE_MANIFEST = Object.freeze({
  schemaVersion: 2,
  revision: "2026-08-28-catalogue-42",
  products: Object.freeze([
    ...
    presentation({
      ...
      sku: "JUW-049",
      name: "Dark Navy Draped Cowl-Neck Side-Cascade Maxi Dress",
      category: "Dresses",
      price: 32500,
      taggedSize: "Size on request",
      fit: "Measurements confirmed before payment",
      condition: "Condition confirmed before payment",
      colour: "Dark navy to near-black",
      availability: "AVAILABLE",
      drop: "Drop 02",
      tone: "coral",
      silhouette: "dress",
      note: "A dark navy-to-near-black maxi shaped by a soft cowl neckline, diagonal waist drape and one long side cascade.",
      story: "A softly draped cowl and sheer-look shoulder panels frame the fitted upper body, while diagonal folds travel into a wearer-left cascade beside the long straight skirt.",
      details: ["Soft draped cowl neckline", "Dark shoulder-panel inserts", "Diagonal waist-to-hip drape", "Long wearer-left side cascade"],
      measurements: [],
      mediaSlots: ["MODEL_FRONT", "MODEL_LEFT_PROFILE", "MODEL_REAR_THREE_QUARTER"],
    }),
    presentation({
      ...
      sku: "JUW-050",
      name: "Neon Chartreuse Asymmetric Ruched-Knot Maxi Dress",
      category: "Dresses",
      price: 32500,
      taggedSize: "Size on request",
      fit: "Measurements confirmed before payment",
      condition: "Condition confirmed before payment",
      colour: "Neon chartreuse-lime",
      availability: "AVAILABLE",
      drop: "Drop 02",
      tone: "coral",
      silhouette: "dress",
    ...
    presentation({
      slug: "mauve-architectural-cutout-open-back-mini-dress",
      sku: "JUW-056",
      name: "Mauve Architectural Cutout Open-Back Mini Dress",
      category: "Dresses",
      price: 28500,
      taggedSize: "Size on request",
      fit: "Measurements confirmed before payment",
      ...
      tone: "coral",
      silhouette: "dress",
      note: "A dusty-mauve fitted mini defined by a high sleeveless neck, architectural front cutout and expansive low-V open back.",
      story: "A high sleeveless neckline frames the architectural centre-front plunge, draped lapel-like panels and side-waist cutouts, while the fitted mini turns to a two-button neck closure and a dramatic low-V open back.",
      details: ["High sleeveless neckline", "Architectural centre-front cutout", "Side-waist cutouts", "Low-V open back with two-button neck closure"],
      measurements: [],
      mediaSlots: ["MODEL_FRONT", "MODEL_LEFT_PROFILE", "MODEL_REAR_THREE_QUARTER"],
    }),
    presentation({
      slug: "near-black-open-back-structured-shoulder-midi-dress",
      sku: "JUW-057",
      name: "Near-Black Open-Back Structured-Shoulder Midi Dress",
      category: "Dresses",
      price: 28500,
      taggedSize: "Size on request",
      fit: "Measurements confirmed before payment",
      condition: "Condition confirmed before payment",
      colour: "Near-black to very dark navy",
      availability: "AVAILABLE",
      drop: "Drop 02",
      tone: "cocoa",
      silhouette: "dress",
      note: "A near-black fitted midi with structured extended shoulders, a clean column front and a very low open back.",
      story: "A shallow boat-to-round neckline and extended cap shoulders sharpen the clean fitted column, while the back drops to a low V near the waist with centre ruching and a vertical rear seam.",
      details: ["Shallow boat-to-round neckline", "Structured extended cap shoulders", "Clean fitted midi column", "Low-V open back with centre ruching"],
      measurements: [],
      mediaSlots: ["MODEL_FRONT", "MODEL_LEFT_PROFILE", "MODEL_REAR_THREE_QUARTER"],
    }),
    presentation({
      slug: "lime-one-shoulder-rosette-ruched-mini-dress",
      sku: "JUW-058",
      name: "Lime One-Shoulder Rosette Ruched Mini Dress",
      category: "Dresses",
      price: 28500,
      taggedSize: "Size on request",
      fit: "Measurements confirmed before payment",
      condition: "Condition confirmed before payment",
      colour: "Bright lime green",
      availability: "AVAILABLE",
      drop: "Drop 02",
      tone: "moss",
      silhouette: "dress",
      note: "A bright-lime asymmetric mini with a draped one-shoulder bodice, wide waist and densely ruched skirt.",
      story: "The gathered one-shoulder bodice drapes into a wide fitted waist and dense horizontal skirt ruching, finished with a sculptural hip rosette and long cascading ruffle.",
      details: ["Asymmetric one-shoulder neckline", "Draped gathered bodice", "Wide fitted waist", "Hip rosette with cascading ruffle"],
      measurements: [],
      mediaSlots: ["MODEL_FRONT", "MODEL_LEFT_PROFILE", "MODEL_REAR_THREE_QUARTER"],
    }),
  ]),
