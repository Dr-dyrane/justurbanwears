      ...
      <div className="studio-home-sheet" data-raised={sheetRaised || undefined} ref={sheetRef}>
        ...
        <section className="studio-home-summary" aria-label="Studio summary" ref={sheetContentRef}>
          <ul className="studio-summary-grid">
            ...
            <li><Link aria-label={availableUnits === null ? "Available-now count unavailable" : `Available now ${availableUnits}`} className="studio-summary-item" href="/studio/operations?view=inventory"><span className="studio-summary-orb"><strong>{availableUnits ?? "—"}</strong></span><small>Available now</small></Link></li>
