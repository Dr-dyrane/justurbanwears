...
export function WearSheet({ onDismiss, open, returnFocus, wardrobeItemId }: {
  ...
  return (
    ...
    >
      ...
      {step === "saved" && selected?.outputUrl ? <section className="studio-task-receipt"><div className="studio-receipt-visual"><img alt="Approved private Wear view" src={selected.outputUrl} /></div><div aria-live="polite" className="studio-receipt-copy"><div className="juw-receipt-motion"><WardrobeMotion artwork="logo" polarity="light" size="sm" variant="success" /></div><p className="eyebrow">Kept</p><h3>View saved.</h3><p>Private · not in Shop</p></div></section> : null}
